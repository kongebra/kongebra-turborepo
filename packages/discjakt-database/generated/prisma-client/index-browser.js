...
exports.Prisma.DiscScalarFieldEnum = makeEnum({
  id: 'id',
  name: 'name',
  description: 'description',
  imageUrl: 'imageUrl',
...
exports.Prisma.ProductPriceScalarFieldEnum = makeEnum({
  id: 'id',
  amount: 'amount',
  currency: 'currency',
  productId: 'productId',
...
exports.Prisma.UserDiscFavoritesScalarFieldEnum = makeEnum({
  discId: 'discId',
  userId: 'userId'
});
